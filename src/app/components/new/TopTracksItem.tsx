...
export default function TopTracksItem(props: TopTracksItemProps) {
    if (props.data === null || props.data === undefined) {
        return (
            <div className="grid grid-cols-7 items-center py-2 gap-4 w-full h-full animate-pulse cursor-pointer pr-4">
    ...
    return (
        <a target="_blank" href={props.data.link} className="grid grid-cols-8 items-center py-2 gap-2 w-full h-full pr-4">
            ...
            <div className="flex flex-col col-span-6">
                <h4 className="text-xl truncate">{props.data.title}</h4>
