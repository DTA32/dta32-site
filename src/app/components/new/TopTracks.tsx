...
export default function TopTracks() {
    ...
    return (
        <div className="rounded-xl bg-gray-500/50 flex flex-col w-1/2 min-w-fit h-fit lg:h-auto text-zinc-200 backdrop-blur-md">
            ...
            <div className="flex flex-col divide-y lg:overflow-y-auto">
